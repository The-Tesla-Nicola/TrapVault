...
urlpatterns = [
    ...
    path('api/sessions/<uuid:session_id>/', m.api_session_detail, name='api_session_detail'),
    path('api/sessions/<uuid:session_id>/action/', m.api_session_action, name='api_session_action'),
    ...
    path('api/siem/alerts/<uuid:alert_id>/ack/', siem.siem_acknowledge_alert, name='siem_ack'),
    ...
    path('api/siem/rules/<uuid:rule_id>/', siem.siem_alert_rule_detail, name='siem_rule_detail'),
    path('api/siem/timeline/<str:fingerprint>/', siem.siem_session_timeline,   name='siem_timeline'),
    ...
    path('api/siem/ml-anomaly/<uuid:session_id>/',  siem.get_ml_anomaly,          name='siem_ml_anomaly'),
    path('api/siem/threat-intel/<str:ip_address>/', siem.get_threat_intel,         name='siem_threat_intel_detail'),
    path('api/soar/block/<uuid:session_id>/',       siem.block_session_api,       name='soar_block'),
    path('api/soar/unblock/<uuid:session_id>/',     siem.unblock_session_api,     name='soar_unblock'),

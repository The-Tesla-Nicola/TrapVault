#!/bin/bash
# TrapVault — Professional Feature Testing Script
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}TrapVault - Professional Feature Test${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
curl -s "${BASE_URL}/monitor/api/siem/threat-intel/185.220.101.1/" | python3 -m json.tool || echo "  Monitor session required"
